...
Now we use the ccmean function with a limit of 4 years (1461 days), we also add the interpolation term which affects the ZT estimate. By default this parameter is set to zero, but to replicate the results of the Stata implementation we set it to 1.
